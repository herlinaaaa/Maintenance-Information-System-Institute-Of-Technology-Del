        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Unduh</a>
                        <div class="dropdown-menu rounded-0 m-0">
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h3 class="display-3 font-weight-bold text-white">Dokumen</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Dokumen</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dokumen as $row) : ?>
                            <tr>
                                ...
                                <!-- <td><?= $row['file']; ?></td> -->
                               <td align="left"><a href="unduhdok.php?file=<?php echo $row['file'] ?>" class="btn btn-warning btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin mendwonload dokumen ?');">
                               <?= $row['file']; ?>
                                </a></td>
                            </tr>
                            <?php endforeach; ?>
