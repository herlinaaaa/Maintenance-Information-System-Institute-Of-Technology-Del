        ...
        <div class="card border-0 shadow rounded-3 my-5">
          ...
          <h5 class="card-title text-center mb-5 fw-light fs-5">Khusus Sivitas IT Del</h5><br>
            ...
            <div class="form-floating mb-3">
              ...
              <div class="d-grid">
                <center><button class="btn btn-primary btn-login text-uppercase fw-bold" name="registrasi" type="submit">Daftar</button></center>
              </div>
              <hr class="my-4">
              <h5 class="card-title text-center mb-5 fw-light fs-5">Sudah punya akun ? || <a href="login.php" > Login </a></h5>
