...
$dokumen = query("SELECT * FROM dokumen ORDER BY id_dok DESC");
...
<body>
                ...
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Data</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="datalainnya.php" class="dropdown-item active">Data Dokumen</a>
                        </div>
                    </div>
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h3 class="display-3 font-weight-bold text-white">Data Dokumen</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Data Dokumen</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
  ...
  <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <a href="add_datalainnya.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data</a>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-md">
                ...
                <thead class="table-dark">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dokumen as $row) : ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td align="left"><?= $row['nama_dok']; ?></td>
                                <td align="left"><?= $row['file']; ?></td>
                                <td>
                                    <a href="deletelainnya.php?id_dok=<?= $row['id_dok']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data?');"><i class="bi bi-trash-fill"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                    </tbody>
