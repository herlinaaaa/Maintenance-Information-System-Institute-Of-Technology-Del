    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          ...
          <h5 class="card-title text-center mb-5 fw-light fs-5">Admin Sarana & Prasarana IT Del</h5><br>
            ...
            <div class="form-floating mb-3">
              ...
              <div class="d-grid">
                <center><button class="btn btn-primary btn-login text-uppercase fw-bold" name="admin" type="submit">Login</button></center>
              </div>
              <hr class="my-4">
              <h5 class="card-title text-center mb-5 fw-light fs-5">Bukan Admin ? || <a href="../login.php" > Login User </a></h5>
