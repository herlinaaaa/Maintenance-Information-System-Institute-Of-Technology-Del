...
<head>
    <meta charset="utf-8">
    <title>Personel Organisasi Sarana & Prasarana Institut Teknologi Del</title>
                ...
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Profil</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="personelorg.php" class="dropdown-item active">Personel Organisasi</a>
                        </div>
                    </div>
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h3 class="display-3 font-weight-bold text-white">Personel Organisasi</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Personel Organisasi</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
   ...
   <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Personel Organisasi</span></p>
            </div><br>
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="../img/cowo.jpeg" alt="" >
                        <div
                    ...
                    <h4> Oberlin Pangaribuan  </h4>
                    <i>Koordinator Maintenance</i>
                </div>
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="../img/cewe.jpeg" alt="" >
                        <div
                            class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                            <a class="btn btn-outline-light text-center mr-2 px-0" style="width: 38px; height: 38px;"
                                href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <h4>Flora Hutahaean </h4>
                    <i>Admin Maintenance</i>
                </div>
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="../img/cowo.jpeg" alt="" >
