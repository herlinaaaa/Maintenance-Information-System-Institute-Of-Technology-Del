...
<head>
    <meta charset="utf-8">
    <title>Tugas - Fungsi Sarana & Prasarana Institut Teknologi Del</title>
...
<body>
                ...
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Profil</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="tugasfungsi.php" class="dropdown-item active">Tugas & Fungsi</a>
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h3 class="display-3 font-weight-bold text-white">Tugas & Fungsi</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Tugas & Fungsi</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
     ...
     <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg">
                    <h1 class="mb-4">Tugas Sarana & Prasarana IT Del</h1>
                    <p>
                    Fungsi Tugas ialah perwujudan tugas di bidang tertentu yang dilakukan dalam rangka menjangkau sebuah tujuan. Definisi lain melafalkan bahwa fungsi ialah sekelompok kegiatan yang termasuk pada jenis yang sama menurut sifat atau pelaksanaannya.Suatu organisasi mengadakan fungsi-fungsi dalam rangka mengemban sebuah tugas pokok.
                    </p>
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-12">
                            <ol type="1">
                                <li> Melakukan perbaikan kerusakan terkait bangunan,plumbing dan listrik</li>
                                <li> Melakukan pemeliharaan bangunan</li>
                                <li> Membantu Sivitas Del dalam tugas-tugas tertentu yang membutuhkan jasa maintenance</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg">
                    <h1 class="mb-4">Fungsi Sarana & Prasarana IT Del</h1>
                    <p>
                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-12">
                            <ol type="1">
                                <li> Sebagai penunjang kelancaran aktivitas proses belajar mengajar baik dalam kampus,kantor asrama dan hunian para Tendik</li>
                            </ul>
                        </div>
                    </div>
                </div>
