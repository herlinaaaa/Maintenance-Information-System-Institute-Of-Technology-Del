...
<head>
    <meta charset="utf-8">
    <title>Visi - Misi Sarana & Prasarana Institut Teknologi Del</title>
   ...
   <div class="container-fluid bg-light position-relative shadow">
                ...
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Profil</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="visimisi.php" class="dropdown-item active">Visi & Misi</a>
    ...
    <div class="container-fluid py-6">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-15">
                    <h1 class="mb-4">Visi Sarana & Prasarana IT Del</h1>
                    <p>
                    Visi menjadi alasan utama dari dibentuknya lembaga tersebut. Dan ini sudah mendasar sehingga tidak mungkin sebuah organisasi didirikan tanpa adanya visi.
                    </p>
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-9">
                            <ol>
                                <li class="py-2 border-top border-bottom"> Terwujudnya kenyamanan dan kelancaran aktivitas akademica terkait listrik</li>
                                <li class="py-2 border-bottom"> Terwujudnya kenyamanan dan kelancaran aktivitas akademica terkait bangunan</li>
                                <li class="py-2 border-bottom"> Terwujudnya kenyamanan dan kelancaran aktivitas akademica terkait  air</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h1 class="mb-4">Misi Sarana & Prasarana IT Del</h1>
                    <p>
                    Misi secara umum adalah serangkaian hal yang dilakukan untuk mencapai sebuah visi.
                    </p>
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-12">
                            <ol>
                                <li class="py-2 border-top border-bottom"> Memberikan pelayanan yang cepat dan tanggap terhadap keluhan user</li>
                                <li class="py-2 border-bottom"> Memberi manfaat dan kontribusi yang baik bagi akademika terkait kebutuhan jasa unit maintenance</li>
                            </ol>
                        </div>
                    </div>
                </div>
