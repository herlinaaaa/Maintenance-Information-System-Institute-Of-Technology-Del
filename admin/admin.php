        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="admin.php" class="nav-item nav-link active">Data Lapor Maintenance</a>
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h3 class="display-3 font-weight-bold text-white">Data Lapor Kerusakan Maintenance</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Data Lapor Kerusakan Maintenance</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
                    ...
                    <tbody>
                        ...
                        <?php foreach ($lapor as $row) : ?>
                            <tr>
                                ...
                                <td align="left" width="90px"><?= $row['damage']; ?></td>
                                <td>
