...
<body>
    ...
    <!-- Navbar End -->
      ...
      <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
            <h3 class="display-3 font-weight-bold text-white">Jadwal Kerja</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Jadwal Kerja</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
  ...
  <div class="container">
        ...
        <div class="row my-2">
            <div class="col-md">
            <a href="cetak.php" target="_blank" name="cetak" class="btn btn-success ms-1">Lihat Jadwal Lengkap</a>
                <a href="pdf.php" target="_blank" name="pdf" class="btn btn-warning ms-1">Unduh</a>
            </div>
        </div>
        <div class="row my-4">
            <div class="col-md">
