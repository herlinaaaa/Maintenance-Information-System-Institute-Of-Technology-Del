...
<head>
    <meta charset="utf-8">
    <title>Contact Sarana & Prasarana Institut Teknologi Del</title>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">KONTAK</span></p>
                <h1 class="mb-4"></h1>
            </div>
            <div class="row">
                <div class="col-lg-12 mb-10">
                    <p>Hadirnya Sistem Informasi Sarana dan Prasarana bertujuan untuk mempermudah segala urusan pekerjaan, baik dalam penjadwalan maupun kerusakan di IT Del</p>
                    <div class="d-flex">
